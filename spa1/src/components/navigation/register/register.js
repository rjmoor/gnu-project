                    ...
                    <div className="measure">
                        <fieldset id="sign_up" className="ba b--transparent ph0 mh0 white">
                            ...
                            <div className="mt3">
                                ...
                                <input className="pa2 input-reset ba bg-transparent hover-bg-white hover-black w-100 white" type="text" name="name" id="name" />
                            </div>
                            <div className="mt3">
                        ...
                        <div className="lh-copy mt3">
                            <p onClick={() => onRouteChange('home')} className="f6 link dim white db pointer">Home</p>
                        </div>
                    </div>
                </main>
            </article>
